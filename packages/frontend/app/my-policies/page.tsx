    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-2 mb-4 text-sm">
        <div className="flex justify-between">
          ...
          <span className={`font-semibold ${insuranceData.isSettled ? 'text-green-500' : 'text-yellow-500'}`}>
        ...
        {insuranceData.isSettled && (
          <div className="flex justify-between">
            <span className="text-gray-600 dark:text-gray-400">Oracle Answer:</span>
            <span className={`font-semibold ${insuranceData.oracleAnswer === 'Yes' ? 'text-green-500' : 'text-gray-500'}`}>
        ...
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">Policies Sold:</span>
      ...
      <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 disabled:bg-gray-400 transition-colors text-sm font-medium"
              >
        ...
        {isCreator && insuranceData.isSettled && !insuranceData.fundsWithdrawn && insuranceData.oracleAnswer === 'No' && (
          <button
            ...
            className="w-full px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 disabled:bg-gray-400 transition-colors font-medium"
          >
